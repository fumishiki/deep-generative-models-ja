...
> 実装編は [【後編】第4回: 確率論・統計学](/articles/ml-lecture-04-part2) をご覧ください。
...
> **理解度チェック**
> 1. 独立同分布（i.i.d.）の仮定のもとで対数尤度が $\sum_i \log p(x_i|\theta)$ と書ける理由を確率の乗法定理から導け。
> 2. 共役事前分布を使うと事後分布の計算が容易になる理由を、ベータ-二項モデルを例に1文で説明せよ。
...
> **📖 続きは後編へ**
> [【後編】第4回: 確率論・統計学](/articles/ml-lecture-04-part2) では、確率分布・MLE・ベイズ推論を完全実装します。
