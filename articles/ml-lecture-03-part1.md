...
> 実装編は [【後編】第3回: 線形代数 II](/articles/ml-lecture-03-part2) をご覧ください。
...
自動微分の先に、より深い「微分」の世界がある。**変分法**（Calculus of Variations）は、関数ではなく**汎関数**（函数の関数）を最適化する道具だ。
...
> **📖 続きは後編へ**
> [【後編】第3回: 線形代数 II](/articles/ml-lecture-03-part2) では、SVD画像圧縮・Randomized SVD・自動微分フレームワークを完全実装します。
